...
def _sample_rois(roidb, im_scale, batch_idx):
    ...
    #print("fg_inds 0:",fg_inds.shape)
    #print("fg_inds 0:",fg_inds)
    ...
    #print("fg_inds 1:",fg_inds.shape)
    #print("bg_inds 1:",bg_inds.shape)
    # The indices that we're selecting (both fg and bg)
    keep_inds = np.append(fg_inds, bg_inds)

    #print("keep_inds", keep_inds.shape) #keep_inds (512,)
    #print("keep_inds", type(keep_inds)) #keep_inds (512,)
    #exit()
